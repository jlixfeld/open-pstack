...
The table above is the current Cursor sync point. Open Pstack 1.2.1 retains this 0.14.3 sync. `README-UPSTREAM.md` preserves its pstack README verbatim. `CHANGES.md` and `NOTICE.md` describe the adaptations and provenance.
