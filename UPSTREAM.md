...
The table above is the current Cursor sync point. Open Pstack 1.5.0 retains this 0.15.1 sync and routes active work through GPT-6 Astra, Sol, and Luna. `README-UPSTREAM.md` preserves its pstack README verbatim. `CHANGES.md` and `NOTICE.md` describe the adaptations and provenance.

## Monitor baseline facts

- The Eric port-upstream work started from `27e0ce32be3dfc496d1372a4f3d45d91d15007da`.
- The Cursor default-branch head observed at this sync was `f8abeddd1862dc73704e3d719dd73df0d51b8c71`.
- The content-sync commit remains `f8abeddd1862dc73704e3d719dd73df0d51b8c71`; observing a later Cursor head does **not** claim that it was backported.
...
git log --oneline f8abeddd1862dc73704e3d719dd73df0d51b8c71..cursor-upstream/main -- pstack
git diff --stat f8abeddd1862dc73704e3d719dd73df0d51b8c71..cursor-upstream/main -- pstack
```
