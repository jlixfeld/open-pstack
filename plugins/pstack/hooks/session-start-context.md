...
This automatic routing does not authorize provider egress. Before dispatching a configured role, follow the authorization boundary in `pstack:poteto-mode`'s `references/provider-dispatch.md`.
