...
| Schemas before guards | At an external boundary, use the repository's runtime schema library and infer the TypeScript type from it. Do not add a dependency when no schema library exists. |
